...
scalar changed_max_ticket /9799/;
...
game_4..sum(i,round2_q4_i(i)*x(i)) + sum(p,sod(p)*sodozarar_index_q4(p))=l=changed_max_ticket;
...
execute_unload 'last_outputs_c2', xall
